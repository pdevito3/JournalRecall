...
public static class UserSettingsEndpoints
{
    public static IEndpointRouteBuilder MapUserSettings(this IEndpointRouteBuilder app)
    {
        ...
        {
            var result = await sender.Send(new UpdateUserSettings.Command(
                body.TimeZoneId, body.LocationCaptureEnabled, body.RequirePeopleTagApproval, body.ClientSavedAt));
