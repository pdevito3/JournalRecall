...
public static class ServiceRegistration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        services.AddScoped<JournalRecall.Api.Domain.Sessions.Services.CleanupPostProcessor>();
        services.AddScoped<JournalRecall.Api.Domain.Sessions.Services.PeopleTagService>();
