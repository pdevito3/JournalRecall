...
namespace JournalRecall.Api.Migrations
{
    ...
    [Migration("20260612010530_DPoPBoundRefreshChain")]
    partial class DPoPBoundRefreshChain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JournalRecall.Api.Domain.Identity.RefreshToken", b =>
                {
                    ...
                    b.Property<string>("BoundKeyThumbprint")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("JournalRecall.Api.Domain.Identity.User", b =>
                {
                    ...
                    b.Property<long?>("SettingsSavedAt")
                        .HasColumnType("INTEGER");

                    b.Property<long>("SettingsUpdatedAt")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("JournalRecall.Api.Domain.Sessions.Session", b =>
                {
                    ...
                    b.Property<int>("RawDraftRevisionNumber")
                        .HasColumnType("INTEGER");

                    b.Property<long>("RawDraftSavedAt")
                        .HasColumnType("INTEGER");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Activity", "JournalRecall.Api.Domain.Sessions.Session.Activity#Activity", b1 =>
                        {
                            b1.IsRequired();
