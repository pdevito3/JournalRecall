...
/// <summary>
/// Pure test: the journaling day is the local calendar date in the user's timezone (CONTEXT.md). The
/// boundary case — two instants 20 minutes apart straddling local midnight — must land on different days
/// in a zone but the same day in UTC.
/// </summary>
public class journaling_day_tests
{
